...
import RedirectLogistration from '../common-components/RedirectLogistration';
...
const ProgressiveProfiling = (props) => {
  ...
  useEffect(() => {
    console.log(registrationEmbedded);
    if (registrationEmbedded) {
      console.log('fetching in use effect');
  ...
  useEffect(() => {
    console.log('welcomepage: ', welcomePageContext);
  ...
  console.log('api status: ', welcomePageContextApiStatus);
